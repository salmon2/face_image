...
def start(url):
    ...
    for (i, rect) in enumerate(rects):
        ...
        result = 'nose trouble : ' + str((count/mogong)*100)
        ...
        result += '\n' + 'left check : ' + str((count2/mogong2)*100)
        ...
        result += '\n'+ 'right check trouble : ' + str((count3/mogong3)*100)
...
if __name__ == "__main__":
    print(start("https://plaluvs-image.s3.ap-northeast-2.amazonaws.com/static/sample4.jpg"))
